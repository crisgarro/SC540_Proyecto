...
-- Create table Users with an identity column
CREATE TABLE Users (
...
-- Create table User_Roles with an identity column
...
-- Create table Products with an identity column
...
-- Create table Orders with an identity column
CREATE TABLE Orders (
...
-- Create table Order_Items with an identity column
...
-- Create table Cart with an identity column
CREATE TABLE Cart (
  CartID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  UserID NUMBER
) TABLESPACE CravyPizzaHuB;

-- Create table Cart_Items with an identity column
...
-- Create table Promotions with an identity column
...
-- Create table Applied_Promotions with an identity column
...
-- Create table Notifications with an identity column
...
-- Create table Rewards with an identity column
